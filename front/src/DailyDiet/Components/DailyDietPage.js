...
const DailyDietPage = React.createClass({
    componentWillMount () {
        let {onComponentLoad} = this.props;
        onComponentLoad();
    },
    render () {
        let {child_tests, children, onSubmitForm, onDelete, showFormClick, ui_form_open, onCloseForm, onChangeCurrentChild, edit_item} = this.props;
